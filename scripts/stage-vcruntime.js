...
// can place them next to the Wcash Warden Testnet executable via extraFiles.
//
...
// vcruntime140.dll is required by native.node; ending up with nothing means the
// redistributable is not the one this build needs.
if (copied === 0) {
